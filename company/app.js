...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:qi,depthTest:!1,depthWrite:!1})}function cS(r,t,e){return new ii({name:"SphericalGaussianBlur",defines:{SAMPLES:rS,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Ah(),fragmentShader:`
		...
		`,blending:qi,depthTest:!1,depthWrite:!1})}function zm(){return new ii({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ah(),fragmentShader:`
		...
		`,blending:qi,depthTest:!1,depthWrite:!1})}function km(){return new ii({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ah(),fragmentShader:`
